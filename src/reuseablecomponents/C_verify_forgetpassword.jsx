...
const C_Verify_ForgetPassword = () => {
  ...
  const [verifyCode, { isLoading, isSuccess, isError, error }] = useVerifyCodeMutation();
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormErrors({
        ...formErrors,
        general: err.data?.message || 'Failed to verify code. Please try again.'
      });
    }
  };
      ...
      <div className="w-full lg:w-max-w-7xl flex items-center justify-center relative p-4 md:p-0">
        <div className="border-2 border-black p-3 w-full max-w-md px-4 md:px-8">
          <div className="mb-8 text-center md:text-left">
            ...
            <h2 className="text-xl md:text-2xl font-semibold">Code Verification</h2>
          </div>
